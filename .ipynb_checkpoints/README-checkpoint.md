**TLDR:**
To run from top level folder:
- `nvcc run_electric_field_mc.cu -o mc.out`
- `./mc.out 50000000 1000000 123456789 4`
- `gcc process_photon_packets.c -lm -o process.out`
- `./process.out photon_db.bin ./Outputs/my_photon_output.dat`
- `cd Output_Processing/`
- `matlab` (assuming a CLI for matlab)
- `plot_Phase_vs_CPR`
- View my_plot.jpg in Output_Processing
